...
/*
bool v3d::vulkan::Devices::init( const std::vector<vk::PhysicalDevice>& physicalDevices, const vk::SurfaceKHR& surface)
{
...
bool v3d::vulkan::Devices::isSuitable(const vk::PhysicalDevice& physicalDevice)
{
	auto& logger = v3d::Logger::getInstance();
...
vk::Device v3d::vulkan::Devices::createDeviceUnique(vk::DeviceCreateInfo& createInfo) const
{
	return physicalDevice.createDevice(createInfo);
}

std::vector<vk::QueueFamilyProperties> v3d::vulkan::Devices::getQueueFamilyProperties() const
{
