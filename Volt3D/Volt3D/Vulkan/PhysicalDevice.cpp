...
/*
bool v3d::vulkan::PhysicalDevice::init( vk::UniqueInstance & instance )
{
...
vk::UniqueDevice v3d::vulkan::PhysicalDevice::createLogicalDevice( const vk::DeviceCreateInfo& createInfo )
{
