...
namespace v3d
{
	...
	/**
	*	@class InputManager
	*	This class manages all inputs from keyboard, mouse and gamdpads.
	*	
	*	Uses GLFW for keyboard and mouse.
	*	Uses SDL2 for gamepads.
	*
	...
	*/
	...
	public:
		...
		//V3D_SINGLETON_GET_INSTANCE(InputManager);
		//V3D_SINGLETON_DELETES(InputManager);
